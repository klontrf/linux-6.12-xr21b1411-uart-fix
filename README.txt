...
======================
Version 1H  2026/1/1
    Fix compilation errors for Linux kernel 6.12
    Migrate <asm/unaligned.h> header file to <linux/unaligned.h> header file
    Update UART driver calls to match new kernel APIs
